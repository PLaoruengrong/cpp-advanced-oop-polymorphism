# Advanced C++ Object-Oriented Programming and Polymorphism

This repository contains C++ projects exploring advanced object-oriented programming concepts including polymorphism, inheritance, exception handling, and modular class design.
...
* **Implementation:** Models a structured workplace environment where concrete types (`SalariedEmployee`, `PieceWorker`, `HourlyWorker`) override base interfaces to compute distinct logic dynamically. Demonstrates polymorphic processing using std::vector<Employee*>.
...
* **Aggregation:** Implements loose lifecycles utilizing weak references or constant pointer tracking (`std::vector<const Instrument*>`), allowing elements to reside independently in global scopes while maintaining safe object relationships.
